...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1180, 820))
        MainWindow.setUnifiedTitleAndToolBarOnMac(False)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.widget = QtGui.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(12, 12, 1160, 769))
        ...
        self.gridLayout.addItem(spacerItem, 1, 0, 2, 3)
        ...
        self.gridLayout.addWidget(self.LcdNumber1, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Slider2, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.LcdNumber2, 4, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.Label4.setText(_translate("MainWindow", "Variable name", None))
